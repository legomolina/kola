...
<style>
    ...
    footer {
        ...
        color: color-mix(in srgb, var(--font-color), transparent 25%);
        font-size: .9em;
        box-shadow: 0 0 4px -1px color-mix(in srgb, var(--mhhc-primary-color), white 30%);
    }
